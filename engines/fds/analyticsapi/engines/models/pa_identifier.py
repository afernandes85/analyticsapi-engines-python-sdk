...
class PAIdentifier(object):
    ...
    def __init__(self, id=None, holdingsmode=None, local_vars_configuration=None):  # noqa: E501
        """PAIdentifier - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this PAIdentifier.  # noqa: E501

        User's FactSet account path OR benchmark.  # noqa: E501

        :return: The id of this PAIdentifier.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this PAIdentifier.

        User's FactSet account path OR benchmark.  # noqa: E501

        :param id: The id of this PAIdentifier.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PAIdentifier):
            return False
