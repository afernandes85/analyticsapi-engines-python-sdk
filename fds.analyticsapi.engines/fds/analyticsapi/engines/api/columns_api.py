...
class ColumnsApi(object):
    ...
    def get_pa_column_by_id(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_pa_column_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_pa_column_by_id_with_http_info(id, **kwargs)  # noqa: E501
    ...
    def get_pa_column_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `get_pa_column_by_id`")  # noqa: E501
    ...
    def get_pa_columns(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: dict(str, ColumnSummary)
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.get_pa_columns_with_http_info(**kwargs)  # noqa: E501

    def get_pa_columns_with_http_info(self, **kwargs):  # noqa: E501
        """Get PA columns  # noqa: E501

        This endpoint lists all the PA columns that can be applied to a calculation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_pa_columns_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(dict(str, ColumnSummary), status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='dict(str, ColumnSummary)',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
